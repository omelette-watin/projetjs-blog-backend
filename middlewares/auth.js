...
exports.hasAuthorRole = async (req, res, next) => {
    try {
...
exports.hasAdminRole = async (req, res, next) => {
    try {
        const token = req.headers["x-access-token"]
...
exports.hasCorrectAuthorId = async (req, res, next) => {
    try {
        const token = req.headers["x-access-token"]
        const { id } = req.params
...
exports.hasCorrectId = async (req, res, next) => {
    try {
        const token = req.headers["x-access-token"]
        const { id } = req.params
...
exports.hasCorrectAuthorIdOrIsAdmin = async (req, res, next) => {
    try {
        const token = req.headers["x-access-token"]
        const { id } = req.params
